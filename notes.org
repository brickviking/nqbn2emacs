...
- [[#emacs][Emacs]]
  ...
  - [[#plugins-recommended-by-others][Plugins recommended by others]]
  - [[#windows][Windows]]
  - [[#frames][Frames]]
  - [[#buffers][Buffers]]
  - [[#input][Input]]
  ...
  - [[#org-mode][Org Mode]]
  - [[#magit][magit]]
  - [[#erc-or-erc-tls][erc (or erc-tls)]]
  - [[#exwm][EXWM]]
  - [[#vterm][vterm]]
  - [[#snippets-from-freenodeemacs-and-liberaemacs][Snippets from freenode#emacs and libera#emacs]]
  - [[#tias-moments-try-it-and-see][tias moments (Try It And See)]]
  - [[#other-useful-links-channels-and-the-like][Other useful links, channels and the like]]
...
- [[#programming][Programming]]
  - [[#codemy-normally-payware][Codemy (normally payware)]]
  - [[#freecodecamporg--youtube-channel][FreeCodeCamp.org]]
  - [[#other][Other]]
- [[#music][Music]]
  - [[#classical][Classical]]
  - [[#atmosphericambientdark][Atmospheric/ambient/Dark]]
