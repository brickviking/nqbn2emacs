...
displayed in one or more windows. A window is a "division" of the frame into one or more sections,
each one usually showing the contents of a buffer. Not all buffers have to be visible, but loaded
buffers can usually be displayed in a window. Don't confuse buffers with windows, they are different,
but windows effectively contain buffers.
   |----------------------------------------+------------------------|
   | Command                                | Key                    |
   |----------------------------------------+------------------------|
