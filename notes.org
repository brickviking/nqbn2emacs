...
** Registers
Registers are slots to store stuff in, whether it's a string, a file
position, a rectangle or a region. This section would benefit from
being filled in further, though it's well described in info
