...
I had a problem recently where org mode would reindent my source code when I saved it back after a
=C-c '= episode. I'd head off into (org-edit-src-code), make the changes I needed, but afterwards,
