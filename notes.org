...
[00:33:30]<thuna`> For "extending" syntax classes, what characters would best fit 'string content' and 'comment content'?  I am thinking maybe = and %
...
*** You can use M-x eval =M-:= to display variable's value
