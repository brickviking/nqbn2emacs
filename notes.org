...
#+BEGIN_abstract
 Hints and aids for when you just want to know some stuff. Addresses Emacs and Vim.
#+END_abstract
...
#+MACRO: pagebreak @@latex:\newpage@@ @@html:<div style="page-break-before: always">&nbsp;</div>@@ @@markdown:<div style="page-break-before: always">&nbsp;</div>@@
...
*** =C-x u= - =undo=
  ...
  + Note: can use a numeric prefix =C-u <number> C-x u=, which undoes <number> of actions.
*** =C-k= - =kill-line=
