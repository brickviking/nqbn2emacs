...
These keys work with open buffers and allow you to change between them.
   ...
   |-------------------------------+---------+-----------------------------------------------------|
   | switch-to-buffer              | C-x b   | Switch to provided buffer                           |
   | list-buffers                  | C-x C-b | Splits the window and displays list of open buffers |
...
|--------------+-------------------|  <-- divider line
| First cell   | Second cell       |  <-- hit Tab, creates new table row
| . . .        | . . .             |
#+END_SRC
*** header_tags
